...
<style>
    svg {
        ...
        top: var(--y);
        scale: var(--size);
        animation: calc(var(--size) * 50s) move linear infinite;
    }
    @keyframes move {
        from {
